...
this is cause are averaging over the agreement bet different energetics
"""
...
params_pool.update({'Energies':np.array([36,24,12,0]),'E_ATP':1 }) ### 
...
for world_id in range(number_of_worlds):
    ...
    #         print (assumptions_pool)
            ...
            if exp_condition>=0:
                ...
                nATP_exp[exp_condition]=-DE_pool[exp_condition]-10
                assert -DE_pool[exp_condition] >11,'energy gap needs to be large enought to allow for reversibility' 
    ...
    # =============================================================================
            ...
            print ('world ', world_id,'pool ',pool_id, 'expt', expt_id,'  val ', exp_condition )
